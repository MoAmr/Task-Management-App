...
let TaskService = class TaskService {
    ...
    getTasks() {
        ...
        return this.http.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((response) => response), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
    }
    saveTask(task, checked) {
        const url = '/api/tasks/save';
...
module.exports = __webpack_require__(/*! F:\My Spring Workspace\Jhipster\tasks\src\main\frontend\src\main.ts */"./src/main.ts");
